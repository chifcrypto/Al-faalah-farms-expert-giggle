...
import { StyleSheet, View, Text, Image, ActivityIndicator, ScrollView, SafeAreaView, TouchableOpacity } from 'react-native';
...
const App = () => {
  ...
  const [ultrasonicStatus, setUltrasonicStatus] = useState(0); // New state for ultrasonic status
  ...
  useEffect(() => {
    ...
    fetchFirebaseData('ultrasonicStatus', setUltrasonicStatus); // Fetch ultrasonic status from Firebase
